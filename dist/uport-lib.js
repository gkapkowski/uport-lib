(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('request'), require('is-mobile'), require('web3-provider-engine'), require('util'), require('qr-image')) :
	typeof define === 'function' && define.amd ? define(['request', 'is-mobile', 'web3-provider-engine', 'util', 'qr-image'], factory) :
	(global.uportLib = factory(global.request,global.isMobile,global.ProviderEngine,global.require$$2,global.qrImage));
}(this, (function (request,isMobile,ProviderEngine,require$$2,qrImage) { 'use strict';
